...
public class Favorite {
    ...
    public static final String GUNUNG="SONY";
    public static final String BUKIT="SAMSUNG";
    public static final String PANTAI="VIVO";
    public static final String TAMAN="XIAOMI";
